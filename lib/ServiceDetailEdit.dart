...
import 'NewDamage.dart';

class ServiceDetailEdit extends StatefulWidget {
  @override
  _ServiceDetailEditState createState() => _ServiceDetailEditState();
}

class _ServiceDetailEditState extends State<ServiceDetailEdit> {
            ...
            Container(
              child: Center(
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.center,
                  children: <Widget>[
                    Text("Schedule  Time  :${_timeOfDay.hour}:${_timeOfDay.minute}"),
                    SizedBox(width: 15),
                    new RaisedButton(
...
//                            ));
      ...
      appBar: AppBar(
        title: Text('Service Details Edit '),
      ),
    );
  }
