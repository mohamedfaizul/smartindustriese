...
import 'ServiceDetailEdit.dart';



class ServiceDamageNodamage extends StatefulWidget {
  @override
  _ServiceDamageNodamageState createState() => _ServiceDamageNodamageState();
}

class _ServiceDamageNodamageState extends State<ServiceDamageNodamage> {
...
//                            ));
      ...
      appBar: AppBar(
        title: Text('Service Details No Damage '),
      ),
    );
  }
